...
Controller::Controller(Model::State &goal_, NetOper &netOper)
    : mGoal(goal_), m_netOper(netOper) {}
...
void Controller::setGoal(Model::State newGoal) { mGoal = newGoal; }

NetOper &Controller::netOper() { return m_netOper; }
